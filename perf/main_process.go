...
const (
	...
	MpImportingCommitTrieCommit MpMetricsName = "MP_IMPORTING_COMMITTRIE_COMMIT"
	MpImportingCommitTrieTotal  MpMetricsName = "MP_IMPORTING_COMMITTRIE_TOTAL"
...
var (
	...
	importingCommitTrieCommitTimer = metrics.NewRegisteredTimer("mp/importing/commit/trie/commit", nil)
	importingCommitTrieTotalTimer  = metrics.NewRegisteredTimer("mp/importing/commit/trie/total", nil)
...
func RecordMPMetrics(metricsName MpMetricsName, start time.Time) {
	...
	case MpImportingCommitTrieCommit:
		recordTimer(importingCommitTrieCommitTimer, start)
		//		increaseCounter(importingCommitAllCounter, start)
	case MpImportingCommitTrieTotal:
		recordTimer(importingCommitTrieTotalTimer, start)
		//		increaseCounter(importingCommitAllCounter, start)
