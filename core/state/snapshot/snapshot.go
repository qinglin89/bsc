...
type Snapshot interface {
	...
	Account4HitMetrics(hash common.Hash, hitInXLayer *int) (*Account, error)
	...
	AccountRLP4HitMetrics(hash common.Hash, hitInXLayer *int) ([]byte, error)

	// Storage directly retrieves the storage data associated with a particular hash,
	// within a particular account.
	Storage(accountHash, storageHash common.Hash) ([]byte, error)
	Storage4HitMetrics(accountHash, storageHash common.Hash, hitXLayer *int) ([]byte, error)
